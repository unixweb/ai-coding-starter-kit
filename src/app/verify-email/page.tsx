...
export default function VerifyEmailPage() {
  ...
  async function handleResend() {
    ...
    if (resendError) {
      setError('Email konnte nicht gesendet werden. Bitte versuche es später erneut.')
    } else {
      setResent(true)
    }
    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">Bitte bestätige deine Email-Adresse</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2 text-center text-sm text-muted-foreground">
            ...
            <p>
              Prüfe auch deinen Spam-Ordner, falls die Email nicht in deinem Posteingang ist.
            </p>
          </div>
